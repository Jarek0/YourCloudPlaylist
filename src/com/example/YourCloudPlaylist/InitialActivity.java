...
public class InitialActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isAccessTokenSaved()){
            new SetAccessToken().execute(secret);
        }
        else{
    ...
    class SetAccessToken extends AsyncTask<String,Void,Boolean>{
        ...
        protected Boolean doInBackground(String... params) {
            try {
                DbApi.mDBApi.getSession().setOAuth2AccessToken(params[0]);
                return true;
            }
            catch (Exception e){
                return false;
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if(result){
                DbApi.logged=true;
                Intent openLogActivity=new Intent(InitialActivity.this,MyActivity.class)
                                            .addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                                            .addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK)
                                             .addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(openLogActivity);
